  ...
  .object({
    ...
    features: z
      .object({
        ...
        // COMPAT(teams): added in v0.3.0, remove gate after 2027-02-06 once the
        // daemon floor is >= v0.3.0.
        teams: z.boolean().optional(),
        // COMPAT(chatRoomSubscriptions): added in v0.3.0, remove gate after
