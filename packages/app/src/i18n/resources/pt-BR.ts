...
import { teamV2PtBR } from "./team-v2";
...
export const ptBR: TranslationResources = {
  ...
  composer: {
    ...
    promptLibrary: {
      trigger: "Prompts salvos",
      title: "Prompts salvos",
      new: "Novo",
      searchPlaceholder: "Buscar por nome ou conteúdo",
      insertNamed: "Inserir {{title}}",
      actionsFor: "Gerenciar {{title}}",
      edit: "Editar",
      delete: "Excluir",
      deletingNamed: "Excluindo {{title}}",
      deleteConfirmTitle: "Excluir prompt salvo?",
      deleteConfirmMessage: "Excluir “{{title}}”? Esta ação não pode ser desfeita.",
      reset: "Redefinir biblioteca",
      resetConfirmTitle: "Redefinir prompts salvos?",
      resetConfirmMessage: "Excluir todos os prompts salvos? Esta ação não pode ser desfeita.",
      addTitle: "Novo prompt salvo",
      editTitle: "Editar prompt salvo",
      nameLabel: "Nome",
      namePlaceholder: "Por exemplo, Revisão de código",
      contentLabel: "Prompt",
      ...
      errors: {
        title_required: "Digite um nome",
        title_too_long: "O nome deve ter no máximo 80 caracteres",
        content_required: "Digite um prompt",
        content_too_long: "O prompt deve ter no máximo 50.000 caracteres",
        unableToSave: "Não foi possível salvar o prompt",
        unableToDelete: "Não foi possível excluir o prompt",
        unableToReset: "Não foi possível redefinir os prompts salvos",
      },
    },
    cancel: {
  ...
  statusBar: {
    ...
    cost: {
      ...
      today: "Hoje",
      total: "Total",
      estimateNote: "Os custos de OpenAI e Codex são estimados pelos preços de tokens da API.",
    },
    sessions: {
  ...
  teams: {
    ...
    form: {
      neverStarted: "Essa requisição gerou um time que nunca iniciou. Tente de novo.",
      ...
      task: "Tarefa",
      taskPlaceholder: "O que o time precisa entregar",
      lead: "Lead",
      provider: "Provedor",
      noProviders: "Nenhum provedor neste daemon",
      role: "Função",
      rolePlaceholder: "server",
      responsibility: "Responsabilidade",
      responsibilityPlaceholder: "O que este membro assume e quando o lead deve atribuir trabalho",
      ...
      submit: "Criar time",
      created: "Time criado.",
      cost: "Cria {{agents}} agentes: um lead e {{members}} membros.",
    },
    settings: {
      title: "Configurações da equipe",
      open: "Abrir configurações da equipe",
      details: "Detalhes da equipe",
      editTeam: "Editar equipe",
      members: "Membros ({{count}})",
      taskMissing: "Nenhuma tarefa definida.",
      unsupported: "Atualize este Host para editar a equipe e as responsabilidades.",
      pendingPermissions: "Permissões pendentes",
      responsibilityMissing: "Nenhuma responsabilidade definida.",
      dangerZone: "Ações da equipe",
      openAgent: "Abrir Agent",
      editMember: "Editar membro",
      editMemberNamed: "Editar {{role}}",
      save: "Salvar",
      saved: "Salvo.",
      updateRefused: "Não foi possível atualizar as configurações da equipe.",
    },
    room: {
