...
export const ru: TranslationResources = {
  ...
  composer: {
    ...
    promptLibrary: {
      trigger: "Сохранённые промпты",
      title: "Сохранённые промпты",
      new: "Новый",
      searchPlaceholder: "Поиск по названию или содержимому",
      insertNamed: "Вставить {{title}}",
      actionsFor: "Управление {{title}}",
      edit: "Изменить",
      delete: "Удалить",
      deletingNamed: "Удаление {{title}}",
      deleteConfirmTitle: "Удалить сохранённый промпт?",
      deleteConfirmMessage: "Удалить «{{title}}»? Это действие нельзя отменить.",
      reset: "Сбросить библиотеку",
      resetConfirmTitle: "Сбросить сохранённые промпты?",
      resetConfirmMessage: "Удалить все сохранённые промпты? Это действие нельзя отменить.",
      addTitle: "Новый сохранённый промпт",
      editTitle: "Изменить сохранённый промпт",
      nameLabel: "Название",
      namePlaceholder: "Например, Проверка кода",
      contentLabel: "Промпт",
      contentPlaceholder: "Введите промпт для повторного использования",
      save: "Сохранить",
      loading: "Загрузка промптов...",
      disconnected: "Подключитесь к Host, чтобы использовать сохранённые промпты",
      unsupported: "Обновите этот Host, чтобы использовать сохранённые промпты",
      loadError: "Не удалось загрузить сохранённые промпты",
      corruptData:
        "Данные сохранённых промптов повреждены. Повторите попытку или сбросьте библиотеку.",
      migrationConfirmTitle: "Объединить старые сохранённые промпты?",
      migrationConfirmMessage:
        "На этом устройстве найдено сохранённых промптов: {{count}}. Объединить их с текущим Host? Существующие промпты не будут заменены.",
      migrationConfirm: "Объединить с Host",
      migrationLoading: "Обработка старых промптов...",
      migrationSuccess:
        "Добавлено промптов: {{addedCount}}, пропущено дубликатов: {{skippedCount}}",
      migrationFailed: "Не удалось объединить старые промпты. Они сохранены на этом устройстве.",
      migrationCorrupt:
        "Не удалось прочитать старые локальные промпты. Промпты текущего Host не затронуты.",
      migrationCorruptTitle: "Не удалось прочитать старые сохранённые промпты",
      migrationCorruptMessage:
        "Старые промпты на этом устройстве повреждены. Удалить только эти старые локальные данные? Промпты текущего Host не изменятся.",
      migrationCorruptConfirm: "Удалить старые локальные данные",
      migrationCleanupFailed:
        "Не удалось удалить повреждённые локальные данные. Они остаются на этом устройстве.",
      noResults: "Подходящих промптов нет",
      empty: "Сохранённых промптов пока нет",
      errors: {
        title_required: "Введите название",
        title_too_long: "Название должно содержать не более 80 символов",
        content_required: "Введите промпт",
        content_too_long: "Промпт должен содержать не более 50 000 символов",
        unableToSave: "Не удалось сохранить промпт",
        unableToDelete: "Не удалось удалить промпт",
        unableToReset: "Не удалось сбросить сохранённые промпты",
      },
    },
    cancel: {
  ...
  teams: {
    ...
    form: {
      neverStarted: "Этот запрос создал команду, которая так и не запустилась. Попробуйте ещё раз.",
      ...
      task: "Задача",
      taskPlaceholder: "Что команда должна сделать",
      lead: "Лид",
      provider: "Провайдер",
      noProviders: "На этом daemon нет провайдеров",
      role: "Роль",
      rolePlaceholder: "server",
      responsibility: "Ответственность",
      responsibilityPlaceholder: "За что отвечает участник и когда лид должен назначать ему работу",
      ...
      cost: "Создаст {{agents}} агентов: лид и {{members}} участников.",
    },
    settings: {
      title: "Настройки команды",
      open: "Открыть настройки команды",
      details: "Сведения о команде",
      editTeam: "Изменить команду",
      members: "Участники ({{count}})",
      taskMissing: "Задача не задана.",
      unsupported: "Обновите Host, чтобы менять команду и обязанности участников.",
      pendingPermissions: "Ожидающие разрешения",
      responsibilityMissing: "Обязанность не задана.",
      dangerZone: "Действия команды",
      openAgent: "Открыть Agent",
      editMember: "Изменить участника",
      editMemberNamed: "Изменить {{role}}",
      save: "Сохранить",
      saved: "Сохранено.",
      updateRefused: "Не удалось обновить настройки команды.",
    },
    room: {
      ...
      mentionReceiptOne:
        "Доставлено или поставлено в очередь для 1 участника. Занятые участники получат сообщение в безопасной точке остановки.",
      mentionReceiptMany:
        "Доставлено или поставлено в очередь для {{count}} участников. Занятые участники получат сообщение в безопасной точке остановки.",
    },
    tabs: {
      chat: "Чат",
      tasks: "Задачи",
  ...
  review: {
    ...
    summary: {
      ...
      selectAgentTitle: "Choose an agent",
      selectAgentSubtitle: "This review stays linked to the first agent you choose",
      createAgent: "New agent",
      createAgentHint: "Uses the most recent agent settings in this workspace",
      newAgentTitle: "Address review comments",
      existingAgents: "Current workspace",
      sendToNamedAgent: "Send to {{name}}",
      associatedAgent: "Linked to",
      agentUnavailable: "Agent unavailable ({{agentId}})",
      deliveryCounts: "{{delivered}} sent · {{pending}} new",
      sendPending: "Add {{count}} new to conversation",
      allSent: "All sent",
      initialPrompt:
        "Address the following review comments by updating the files, then summarize the changes.",
      followUpPrompt: "Continue with the following new or updated review comments.",
      sent: "Sent {{count}} review comments",
      queued: "The agent is running; queued {{count}} review comments",
      copyAll: "Копировать все",
      copyFailed: "Не удалось скопировать комментарии к ревью",
      deleteAll: "Удалить все",
      deleteAllConfirmTitle: "Удалить все комментарии?",
      deleteAllConfirmMessage:
        "Все комментарии к ревью ({{count}}) будут удалены без возможности восстановления.",
    },
  },
  settings: {
    title: "Настройки",
