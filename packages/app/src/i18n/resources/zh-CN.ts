...
import { teamV2ZhCN } from "./team-v2";
...
export const zhCN: TranslationResources = {
  ...
  composer: {
    ...
    promptLibrary: {
      ...
      title: "常用 Prompt",
      new: "新建",
      searchPlaceholder: "搜索名称或内容",
      insertNamed: "插入 {{title}}",
      actionsFor: "管理 {{title}}",
      edit: "编辑",
      delete: "删除",
      deletingNamed: "正在删除 {{title}}",
      deleteConfirmTitle: "删除常用 Prompt？",
      deleteConfirmMessage: "确定删除“{{title}}”吗？此操作无法撤销。",
      reset: "重置集合",
      resetConfirmTitle: "重置常用 Prompt？",
      resetConfirmMessage: "确定删除全部常用 Prompt 吗？此操作无法撤销。",
      addTitle: "新建 Prompt",
      editTitle: "编辑 Prompt",
      nameLabel: "名称",
      ...
      empty: "还没有常用 Prompt",
      errors: {
        title_required: "请输入名称",
        title_too_long: "名称不能超过 80 个字符",
        content_required: "请输入 Prompt",
        content_too_long: "Prompt 不能超过 50,000 个字符",
        unableToSave: "无法保存 Prompt",
        unableToDelete: "无法删除 Prompt",
        unableToReset: "无法重置常用 Prompt",
      },
    },
    cancel: {
  ...
  teams: {
    ...
    form: {
      ...
      title: "新建团队",
      name: "名称",
      namePlaceholder: "这个团队做什么",
      task: "任务",
      taskPlaceholder: "团队要完成的事",
      lead: "Lead",
      provider: "Provider",
      noProviders: "该 daemon 上没有可用 provider",
      role: "角色",
      rolePlaceholder: "server",
      responsibility: "职责",
      responsibilityPlaceholder: "该成员负责什么，以及 Lead 应在什么情况下给它分配任务",
      addMember: "添加成员",
      removeMember: "移除",
      review: "确认",
      back: "返回",
      submit: "创建团队",
      created: "团队已创建。",
      cost: "将创建 {{agents}} 个 agent：1 个 lead 和 {{members}} 个成员。",
    },
    settings: {
      title: "团队设置",
      open: "打开团队设置",
      ...
      members: "成员（{{count}}）",
      taskMissing: "尚未设置任务。",
      unsupported: "升级该 Host 后才能编辑团队信息和成员职责。",
      pendingPermissions: "待处理权限",
      responsibilityMissing: "尚未设置职责。",
      dangerZone: "团队操作",
      openAgent: "打开 Agent",
      editMember: "编辑成员",
      editMemberNamed: "编辑 {{role}}",
      save: "保存",
      saved: "已保存。",
      updateRefused: "团队设置更新失败。",
    },
    room: {
      placeholder: "对团队说点什么…",
      send: "发送",
      ...
      replyLeadFallback: "该成员已离开；如果没有添加其他 @mention，本次回复将通知 Lead。",
      replyHumanLeadFallback: "回复人的消息时，如果没有添加 @mention，将通知 Lead。",
      cancelReply: "取消回复",
      notifiedRecipients: "已通知",
      noRecipientNotified: "消息已保存，但当前没有可通知的成员。",
      showMore: "展开",
  ...
  review: {
    ...
    summary: {
      ...
      sendToAgent: "交给 Agent 处理",
      selectAgentTitle: "选择 Agent",
      selectAgentSubtitle: "首次发送后，本轮 Review 将固定关联到该 Agent",
      createAgent: "新建 Agent",
      createAgentHint: "沿用当前工作区最近 Agent 的配置",
      newAgentTitle: "处理 Review comments",
      existingAgents: "当前工作区",
      sendToNamedAgent: "发送给 {{name}}",
      associatedAgent: "已关联",
      agentUnavailable: "Agent 不可用（{{agentId}}）",
      deliveryCounts: "{{delivered}} 条已发送 · {{pending}} 条新增",
      sendPending: "添加新增 {{count}} 条到对话",
      allSent: "已全部发送",
      initialPrompt: "请处理以下 Review comments，并按评论修改文件。完成后请总结改动。",
      followUpPrompt: "请继续处理以下新增或更新的 Review comments。",
      sent: "已发送 {{count}} 条 Review comments",
      queued: "Agent 正在运行，已将 {{count}} 条 Review comments 加入队列",
      deleteAll: "删除全部",
