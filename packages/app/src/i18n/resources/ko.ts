...
export const ko: TranslationResources = {
  ...
  composer: {
    ...
    promptLibrary: {
      ...
      title: "저장된 프롬프트",
      new: "새로 만들기",
      searchPlaceholder: "이름 또는 내용 검색",
      insertNamed: "{{title}} 삽입",
      actionsFor: "{{title}} 관리",
      edit: "편집",
      delete: "삭제",
      deletingNamed: "{{title}} 삭제 중",
      deleteConfirmTitle: "저장된 프롬프트를 삭제할까요?",
      deleteConfirmMessage: '"{{title}}"을(를) 삭제할까요? 이 작업은 취소할 수 없습니다.',
      reset: "프롬프트 모음 초기화",
      resetConfirmTitle: "저장된 프롬프트를 초기화할까요?",
      resetConfirmMessage: "저장된 프롬프트를 모두 삭제할까요? 이 작업은 취소할 수 없습니다.",
      addTitle: "새 저장된 프롬프트",
      editTitle: "저장된 프롬프트 편집",
      nameLabel: "이름",
      namePlaceholder: "예: 코드 리뷰",
      contentLabel: "프롬프트",
      contentPlaceholder: "재사용할 프롬프트를 입력하세요",
      save: "저장",
      loading: "프롬프트 불러오는 중...",
      disconnected: "저장된 프롬프트를 사용하려면 호스트에 연결하세요",
      unsupported: "저장된 프롬프트를 사용하려면 이 호스트를 업데이트하세요",
      loadError: "저장된 프롬프트를 불러오지 못했습니다",
      corruptData: "저장된 프롬프트 데이터가 손상되었습니다. 다시 시도하거나 모음을 초기화하세요.",
      migrationConfirmTitle: "이전 저장된 프롬프트를 병합할까요?",
      migrationConfirmMessage:
        "이 기기에 저장된 프롬프트 {{count}}개를 찾았습니다. 현재 호스트에 병합할까요? 기존 프롬프트는 대체되지 않습니다.",
      migrationConfirm: "호스트에 병합",
      migrationLoading: "이전 프롬프트 처리 중...",
      migrationSuccess:
        "프롬프트 {{addedCount}}개를 병합하고 중복 {{skippedCount}}개를 건너뛰었습니다",
      migrationFailed: "이전 프롬프트를 병합하지 못했습니다. 이 기기에 그대로 남아 있습니다.",
      migrationCorrupt:
        "이전 로컬 프롬프트를 읽을 수 없습니다. 현재 호스트의 프롬프트에는 영향이 없습니다.",
      migrationCorruptTitle: "이전 저장된 프롬프트를 읽을 수 없습니다",
      migrationCorruptMessage:
        "이 기기에 저장된 이전 프롬프트가 손상되었습니다. 이 로컬 데이터만 삭제할까요? 현재 호스트의 프롬프트는 변경되지 않습니다.",
      migrationCorruptConfirm: "이전 로컬 데이터 삭제",
      migrationCleanupFailed:
        "손상된 로컬 프롬프트 데이터를 삭제하지 못했습니다. 이 기기에 그대로 남아 있습니다.",
      noResults: "일치하는 프롬프트가 없습니다",
      empty: "저장된 프롬프트가 아직 없습니다",
      errors: {
        title_required: "이름을 입력하세요",
        title_too_long: "이름은 80자 이하여야 합니다",
        content_required: "프롬프트를 입력하세요",
        content_too_long: "프롬프트는 50,000자 이하여야 합니다",
        unableToSave: "프롬프트를 저장하지 못했습니다",
        unableToDelete: "프롬프트를 삭제하지 못했습니다",
        unableToReset: "저장된 프롬프트를 초기화하지 못했습니다",
      },
    },
    cancel: {
  ...
  statusBar: {
    ...
    states: {
      loading: "상태 불러오는 중",
      unavailable: "상태를 사용할 수 없습니다",
      unsupported: "이 기능을 사용하려면 호스트를 업데이트하세요.",
    ...
    cost: {
      ...
      today: "오늘",
      total: "전체",
      estimateNote: "OpenAI 및 Codex 비용은 API 토큰 가격을 기준으로 추정됩니다.",
    },
    sessions: {
      title: "에이전트 세션",
      trigger: "세션",
  ...
  message: {
    ...
    actions: {
      ...
      shareFailed: "이 대화를 공유하지 못했습니다.",
      shareRecoveryHint:
        "기본 서비스는 공유 Threadshare 배포입니다. 안정성을 높이려면 자체 Threadshare를 배포하고 daemon.chatShare.baseUrl을 설정하세요.",
      shareTooLarge:
        "도구 결과를 제거한 후에도 이 대화가 5 MiB보다 큽니다. 더 나중의 사용자 메시지를 선택하고 다시 시도하세요.",
  ...
  teams: {
    ...
    form: {
      ...
      title: "새 팀",
      name: "이름",
      namePlaceholder: "이 팀은 무엇을 하나요",
      task: "작업",
      taskPlaceholder: "팀이 끝내야 할 일",
      lead: "리드",
      provider: "프로바이더",
      noProviders: "이 daemon에 사용할 수 있는 프로바이더가 없습니다",
      role: "역할",
      rolePlaceholder: "server",
      responsibility: "책임",
      responsibilityPlaceholder: "이 멤버의 담당 범위와 Lead가 작업을 배정할 조건",
      addMember: "멤버 추가",
      removeMember: "삭제",
      review: "확인",
      back: "뒤로",
      submit: "팀 만들기",
      created: "팀을 만들었습니다.",
      cost: "에이전트 {{agents}}개를 만듭니다: 리드 1명과 멤버 {{members}}명.",
    },
    settings: {
      title: "팀 설정",
      open: "팀 설정 열기",
      ...
      editTeam: "팀 편집",
      members: "멤버 ({{count}})",
      taskMissing: "설정된 작업이 없습니다.",
      unsupported: "팀 정보와 멤버 책임을 편집하려면 Host를 업데이트하세요.",
      pendingPermissions: "대기 중인 권한",
      responsibilityMissing: "설정된 책임이 없습니다.",
      dangerZone: "팀 작업",
      openAgent: "Agent 열기",
      editMember: "멤버 편집",
      editMemberNamed: "{{role}} 편집",
      save: "저장",
      saved: "저장됨.",
      updateRefused: "팀 설정을 업데이트하지 못했습니다.",
    },
    room: {
      placeholder: "팀에게 말하기…",
      send: "보내기",
      ...
      reply: "답장",
      replyingTo: "{{author}}에게 답장",
      replyUnavailable: "원본 메시지를 사용할 수 없습니다",
      replyLeadFallback: "이 멤버는 비활성 상태입니다. 다른 @mention이 없으면 Lead에게 알립니다.",
      replyHumanLeadFallback: "@mention이 없으면 사람에게 보내는 답장을 Lead에게 알립니다.",
      cancelReply: "답장 취소",
      notifiedRecipients: "알림 대상",
      noRecipientNotified: "저장했습니다. 알릴 수 있는 활성 멤버가 없습니다.",
      showMore: "더 보기",
  ...
  review: {
    quote: "인용",
    quoteSelection: "선택한 내용을 작성기에 인용",
    comment: {
      add: "리뷰 댓글 추가",
      edit: "리뷰 댓글 편집",
      delete: "리뷰 댓글 삭제",
    ...
    summary: {
      ...
      copyAll: "모두 복사",
      copyFailed: "리뷰 댓글을 복사하지 못했습니다",
      deleteAll: "모두 삭제",
      deleteAllConfirmTitle: "모든 댓글을 삭제할까요?",
      deleteAllConfirmMessage:
        "리뷰 댓글 {{count}}개를 영구적으로 삭제합니다. 이 작업은 취소할 수 없습니다.",
    },
  },
  settings: {
    title: "설정",
