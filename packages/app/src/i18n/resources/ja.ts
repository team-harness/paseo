...
export const ja: TranslationResources = {
  ...
  composer: {
    ...
    promptLibrary: {
      ...
      title: "保存済みプロンプト",
      new: "新規",
      searchPlaceholder: "名前または内容を検索",
      insertNamed: "{{title}}を挿入",
      actionsFor: "{{title}}を管理",
      edit: "編集",
      delete: "削除",
      deletingNamed: "{{title}}を削除中",
      deleteConfirmTitle: "保存済みプロンプトを削除しますか？",
      deleteConfirmMessage: "「{{title}}」を削除しますか？この操作は取り消せません。",
      reset: "ライブラリをリセット",
      resetConfirmTitle: "保存済みプロンプトをリセットしますか？",
      resetConfirmMessage: "保存済みプロンプトをすべて削除しますか？この操作は取り消せません。",
      addTitle: "保存済みプロンプトを新規作成",
      editTitle: "保存済みプロンプトを編集",
      nameLabel: "名前",
      ...
      errors: {
        title_required: "名前を入力してください",
        title_too_long: "名前は80文字以内で入力してください",
        content_required: "プロンプトを入力してください",
        content_too_long: "プロンプトは50,000文字以内で入力してください",
        unableToSave: "プロンプトを保存できませんでした",
        unableToDelete: "プロンプトを削除できませんでした",
        unableToReset: "保存済みプロンプトをリセットできませんでした",
      },
    },
    cancel: {
  ...
  teams: {
    ...
    form: {
      ...
      title: "新しいチーム",
      name: "名前",
      namePlaceholder: "このチームの目的",
      task: "タスク",
      taskPlaceholder: "チームに片づけてほしいこと",
      lead: "リード",
      provider: "プロバイダ",
      noProviders: "この daemon に利用できるプロバイダがありません",
      role: "役割",
      rolePlaceholder: "server",
      responsibility: "担当範囲",
      responsibilityPlaceholder: "このメンバーの担当と Lead が作業を割り当てる条件",
      addMember: "メンバーを追加",
      removeMember: "削除",
      review: "確認",
      back: "戻る",
      submit: "チームを作成",
      created: "チームを作成しました。",
      cost: "エージェントを {{agents}} 個作ります：リード 1 とメンバー {{members}}。",
    },
    settings: {
      title: "チーム設定",
      open: "チーム設定を開く",
      ...
      editTeam: "チームを編集",
      members: "メンバー（{{count}}）",
      taskMissing: "タスクが設定されていません。",
      unsupported: "チーム情報と担当を編集するには Host を更新してください。",
      pendingPermissions: "保留中の権限",
      responsibilityMissing: "担当が設定されていません。",
      dangerZone: "チーム操作",
      openAgent: "Agent を開く",
      editMember: "メンバーを編集",
      editMemberNamed: "{{role}} を編集",
      save: "保存",
      saved: "保存しました。",
      updateRefused: "チーム設定を更新できませんでした。",
    },
    room: {
      ...
      reply: "返信",
      replyingTo: "{{author}} に返信",
      replyUnavailable: "元のメッセージは利用できません",
      replyLeadFallback: "このメンバーは不在です。別の @mention がなければ Lead に通知します。",
      replyHumanLeadFallback: "@mention がなければ、人への返信は Lead に通知されます。",
      cancelReply: "返信をキャンセル",
      notifiedRecipients: "通知先",
      noRecipientNotified: "保存しました。通知できるメンバーはいません。",
      showMore: "続きを表示",
