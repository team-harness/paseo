...
export const fr: TranslationResources = {
  ...
  composer: {
    ...
    promptLibrary: {
      trigger: "Prompts enregistrés",
      title: "Prompts enregistrés",
      new: "Nouveau",
      searchPlaceholder: "Rechercher un nom ou un contenu",
      insertNamed: "Insérer {{title}}",
      actionsFor: "Gérer {{title}}",
      edit: "Modifier",
      delete: "Supprimer",
      deletingNamed: "Suppression de {{title}}",
      deleteConfirmTitle: "Supprimer le prompt enregistré ?",
      deleteConfirmMessage: "Supprimer « {{title}} » ? Cette action est irréversible.",
      reset: "Réinitialiser la bibliothèque",
      resetConfirmTitle: "Réinitialiser les prompts enregistrés ?",
      resetConfirmMessage:
        "Supprimer tous les prompts enregistrés ? Cette action est irréversible.",
      addTitle: "Nouveau prompt enregistré",
      editTitle: "Modifier le prompt enregistré",
      nameLabel: "Nom",
      namePlaceholder: "Par exemple, Revue de code",
      contentLabel: "Prompt",
      ...
      errors: {
        title_required: "Saisissez un nom",
        title_too_long: "Le nom doit contenir 80 caractères au maximum",
        content_required: "Saisissez un prompt",
        content_too_long: "Le prompt doit contenir 50 000 caractères au maximum",
        unableToSave: "Impossible d'enregistrer le prompt",
        unableToDelete: "Impossible de supprimer le prompt",
        unableToReset: "Impossible de réinitialiser les prompts enregistrés",
      },
    },
    cancel: {
  ...
  statusBar: {
    ...
    sessions: {
      ...
      status: {
        permission: "En attente d'autorisation",
        error: "Erreur",
        finished: "Terminé",
        active: "Actif",
      },
    ...
    history: {
      ...
      trigger: "Historique",
      group: "Récentes",
      empty: "Aucun historique de session",
      loading: "Chargement de l'historique",
      error: "Impossible de charger l'historique",
      actions: {
        openAgent: "Ouvrir {{title}}",
        refresh: "Actualiser l'historique",
        refreshing: "Actualisation de l'historique",
      },
    },
    pins: {
      title: "Sessions épinglées",
      trigger: "Épingler",
      empty: "Aucune session épinglée",
      actions: {
        openSession: "Ouvrir {{title}}",
        pinSession: "Épingler {{title}}",
        unpinSession: "Désépingler {{title}}",
      },
    },
  },
  agentList: {
  ...
  message: {
    ...
    actions: {
      ...
      shareRecoveryHint:
        "Le service par défaut est un déploiement Threadshare partagé. Pour plus de fiabilité, déployez votre propre Threadshare et configurez daemon.chatShare.baseUrl.",
      shareTooLarge:
        "La conversation dépasse encore 5 MiB après la suppression des résultats des outils. Choisissez un message utilisateur plus récent et réessayez.",
  ...
  teams: {
    ...
    room: {
      ...
      reply: "Répondre",
      replyingTo: "Réponse à {{author}}",
      replyUnavailable: "Message d’origine indisponible",
      replyLeadFallback: "Ce membre n’est plus actif. Sans autre @mention, le Lead sera averti.",
      replyHumanLeadFallback: "Sans @mention, les réponses aux personnes avertissent le Lead.",
      cancelReply: "Annuler la réponse",
      notifiedRecipients: "Notifiés",
      noRecipientNotified: "Enregistré. Aucun membre actif n’a pu être averti.",
