...
export const es: TranslationResources = {
  ...
  composer: {
    ...
    promptLibrary: {
      trigger: "Prompts guardados",
      title: "Prompts guardados",
      new: "Nuevo",
      searchPlaceholder: "Buscar por nombre o contenido",
      insertNamed: "Insertar {{title}}",
      actionsFor: "Gestionar {{title}}",
      edit: "Editar",
      delete: "Eliminar",
      deletingNamed: "Eliminando {{title}}",
      deleteConfirmTitle: "¿Eliminar el prompt guardado?",
      deleteConfirmMessage: "¿Eliminar «{{title}}»? Esta acción no se puede deshacer.",
      reset: "Restablecer biblioteca",
      resetConfirmTitle: "¿Restablecer los prompts guardados?",
      resetConfirmMessage:
        "¿Eliminar todos los prompts guardados? Esta acción no se puede deshacer.",
      addTitle: "Nuevo prompt guardado",
      editTitle: "Editar prompt guardado",
      nameLabel: "Nombre",
      namePlaceholder: "Por ejemplo, Revisión de código",
      contentLabel: "Prompt",
      ...
      errors: {
        title_required: "Escribe un nombre",
        title_too_long: "El nombre debe tener 80 caracteres o menos",
        content_required: "Escribe un prompt",
        content_too_long: "El prompt debe tener 50.000 caracteres o menos",
        unableToSave: "No se pudo guardar el prompt",
        unableToDelete: "No se pudo eliminar el prompt",
        unableToReset: "No se pudieron restablecer los prompts guardados",
      },
    },
    cancel: {
  ...
  statusBar: {
    ...
    sessions: {
      ...
      trigger: "Sesiones",
      empty: "No hay sesiones de agentes",
      groups: {
  ...
  message: {
    actions: {
      ...
      shareRecoveryHint:
        "El servicio predeterminado es una implementación compartida de Threadshare. Para mayor fiabilidad, implementa tu propio Threadshare y configura daemon.chatShare.baseUrl.",
      shareTooLarge:
        "La conversación sigue superando los 5 MiB después de eliminar los resultados de las herramientas. Elige un mensaje de usuario posterior e inténtalo de nuevo.",
  ...
  teams: {
    ...
    form: {
      ...
      title: "Nuevo equipo",
      name: "Nombre",
      namePlaceholder: "Para qué es este equipo",
      task: "Tarea",
      taskPlaceholder: "Lo que el equipo debe lograr",
      lead: "Lead",
      provider: "Proveedor",
      noProviders: "No hay proveedores en este daemon",
      role: "Rol",
      rolePlaceholder: "server",
      responsibility: "Responsabilidad",
      responsibilityPlaceholder: "Qué asume este miembro y cuándo debe asignarle trabajo el lead",
      ...
      cost: "Crea {{agents}} agentes: un lead y {{members}} miembros.",
    },
    settings: {
      title: "Configuración del equipo",
      open: "Abrir configuración del equipo",
      details: "Detalles del equipo",
      editTeam: "Editar equipo",
      members: "Miembros ({{count}})",
      taskMissing: "No hay ninguna tarea definida.",
      unsupported: "Actualiza este Host para editar el equipo y las responsabilidades.",
      pendingPermissions: "Permisos pendientes",
      responsibilityMissing: "No hay ninguna responsabilidad definida.",
      dangerZone: "Acciones del equipo",
      openAgent: "Abrir Agent",
      editMember: "Editar miembro",
      editMemberNamed: "Editar {{role}}",
      save: "Guardar",
      saved: "Guardado.",
      updateRefused: "No se pudo actualizar la configuración del equipo.",
    },
    room: {
      placeholder: "Dile algo al equipo…",
      send: "Enviar",
      notPosted: "Ese mensaje no se publicó.",
    ...
    tasks: {
      empty: "Nada asignado todavía.",
      state: {
        queued: "En cola",
        dispatched: "Trabajando",
      },
      outcome: {
        completed: "Listo",
        failed: "Falló",
