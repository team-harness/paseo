...
export const ar: TranslationResources = {
  ...
  composer: {
    ...
    promptLibrary: {
      trigger: "المطالبات المحفوظة",
      title: "المطالبات المحفوظة",
      new: "جديد",
      searchPlaceholder: "البحث بالاسم أو المحتوى",
      insertNamed: "إدراج {{title}}",
      actionsFor: "إدارة {{title}}",
      edit: "تعديل",
      delete: "حذف",
      deletingNamed: "جارٍ حذف {{title}}",
      deleteConfirmTitle: "حذف المطالبة المحفوظة؟",
      deleteConfirmMessage: "هل تريد حذف «{{title}}»؟ لا يمكن التراجع عن هذا الإجراء.",
      reset: "إعادة تعيين المكتبة",
      resetConfirmTitle: "إعادة تعيين المطالبات المحفوظة؟",
      resetConfirmMessage: "هل تريد حذف جميع المطالبات المحفوظة؟ لا يمكن التراجع عن هذا الإجراء.",
      addTitle: "مطالبة محفوظة جديدة",
      editTitle: "تعديل المطالبة المحفوظة",
      nameLabel: "الاسم",
      namePlaceholder: "مثال: مراجعة الكود",
      contentLabel: "المطالبة",
      ...
      errors: {
        title_required: "أدخل اسمًا",
        title_too_long: "يجب ألا يتجاوز الاسم 80 حرفًا",
        content_required: "أدخل مطالبة",
        content_too_long: "يجب ألا تتجاوز المطالبة 50,000 حرف",
        unableToSave: "تعذر حفظ المطالبة",
        unableToDelete: "تعذر حذف المطالبة",
        unableToReset: "تعذرت إعادة تعيين المطالبات المحفوظة",
      },
    },
    cancel: {
  ...
  teams: {
    ...
    form: {
      ...
      title: "فريق جديد",
      name: "الاسم",
      namePlaceholder: "ما الغرض من هذا الفريق",
      task: "المهمة",
      taskPlaceholder: "ما يجب أن ينجزه الفريق",
      lead: "القائد",
      provider: "المزوّد",
      noProviders: "لا يوجد مزوّدون على هذا الـ daemon",
      role: "الدور",
      rolePlaceholder: "server",
      responsibility: "المسؤولية",
      responsibilityPlaceholder: "ما الذي يملكه هذا العضو ومتى يكلّفه القائد بالعمل",
      addMember: "إضافة عضو",
      removeMember: "إزالة",
      review: "مراجعة",
      back: "رجوع",
      ...
      cost: "سيُنشئ {{agents}} وكلاء: قائدًا و{{members}} أعضاء.",
    },
    settings: {
      title: "إعدادات الفريق",
      open: "فتح إعدادات الفريق",
      details: "تفاصيل الفريق",
      editTeam: "تعديل الفريق",
      members: "الأعضاء ({{count}})",
      taskMissing: "لم يتم تعيين مهمة.",
      unsupported: "حدّث المضيف لتعديل تفاصيل الفريق ومسؤوليات الأعضاء.",
      pendingPermissions: "أذونات معلقة",
      responsibilityMissing: "لم يتم تعيين مسؤولية.",
      dangerZone: "إجراءات الفريق",
      openAgent: "فتح Agent",
      editMember: "تعديل العضو",
      editMemberNamed: "تعديل {{role}}",
      save: "حفظ",
      saved: "تم الحفظ.",
      updateRefused: "تعذر تحديث إعدادات الفريق.",
    },
    room: {
      ...
      reply: "رد",
      replyingTo: "الرد على {{author}}",
      replyUnavailable: "الرسالة الأصلية غير متاحة",
      replyLeadFallback: "هذا العضو لم يعد نشطًا. من دون @mention آخر، سيتم إشعار Lead.",
      replyHumanLeadFallback: "من دون @mention، تُشعر الردود على الأشخاص Lead.",
      cancelReply: "إلغاء الرد",
      notifiedRecipients: "تم إشعار",
      noRecipientNotified: "تم الحفظ. لا يوجد عضو نشط يمكن إشعاره.",
      showMore: "عرض المزيد",
