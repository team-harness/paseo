...
export const en = {
  ...
  composer: {
    ...
    promptLibrary: {
      ...
      title: "Saved prompts",
      new: "New",
      searchPlaceholder: "Search names or content",
      insertNamed: "Insert {{title}}",
      actionsFor: "Manage {{title}}",
      edit: "Edit",
      delete: "Delete",
      deletingNamed: "Deleting {{title}}",
      deleteConfirmTitle: "Delete saved prompt?",
      deleteConfirmMessage: 'Delete "{{title}}"? This cannot be undone.',
      reset: "Reset library",
      resetConfirmTitle: "Reset saved prompts?",
      resetConfirmMessage: "Delete every saved prompt? This cannot be undone.",
      addTitle: "New saved prompt",
      editTitle: "Edit saved prompt",
      nameLabel: "Name",
      namePlaceholder: "For example, Code review",
      contentLabel: "Prompt",
      ...
      errors: {
        title_required: "Enter a name",
        title_too_long: "Name must be 80 characters or fewer",
        content_required: "Enter a prompt",
        content_too_long: "Prompt must be 50,000 characters or fewer",
        unableToSave: "Couldn't save the prompt",
        unableToDelete: "Couldn't delete the prompt",
        unableToReset: "Couldn't reset saved prompts",
      },
    },
    cancel: {
  ...
  message: {
    actions: {
      ...
      shareFailed: "Unable to share this conversation.",
      shareRecoveryHint:
        "The default service is a shared Threadshare deployment. For greater reliability, deploy your own Threadshare and set daemon.chatShare.baseUrl.",
      shareTooLarge:
        "This conversation is still larger than 5 MiB after tool results were removed. Choose a later user message and try again.",
  ...
  teams: {
    ...
    form: {
      ...
      title: "New Team",
      name: "Name",
      namePlaceholder: "What is this team for",
      task: "Task",
      taskPlaceholder: "What the team should get done",
      lead: "Lead",
      provider: "Provider",
      noProviders: "No providers on this daemon",
      role: "Role",
      rolePlaceholder: "server",
      responsibility: "Responsibility",
      responsibilityPlaceholder: "What this member owns and when the lead should assign it work",
      ...
      cost: "Creates {{agents}} agents: a lead and {{members}} members.",
    },
    settings: {
      title: "Team settings",
      open: "Open Team settings",
      details: "Team details",
      editTeam: "Edit Team",
      members: "Members ({{count}})",
      taskMissing: "No task set.",
      unsupported: "Update this Host to edit Team details and member responsibilities.",
      pendingPermissions: "Pending permissions",
      responsibilityMissing: "No responsibility set.",
      dangerZone: "Team actions",
      openAgent: "Open Agent",
      editMember: "Edit member",
      editMemberNamed: "Edit {{role}}",
      save: "Save",
      saved: "Saved.",
      updateRefused: "The Team settings could not be updated.",
    },
    room: {
